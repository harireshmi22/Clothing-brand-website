...
// Import some placeholder images from assets
import placeholder1 from '../assets/featured.webp';
import placeholder2 from '../assets/mens-collection.webp';
                        ...
                        {orders.length > 0 ? (
                            orders.map((order) => (
                                <tr key={order._id} onClick={() => handleRowClick(order._id)}
                                    ...
                                    <td className="py-2 px-2 sm:py-4 sm:px-4">{order.orderItems.length} item(s)</td>

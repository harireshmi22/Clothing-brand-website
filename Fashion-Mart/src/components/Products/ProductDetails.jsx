        ...
        <div className="p-6">
            <div className="max-w-6xl mx-auto bg-white p-8 rounded-lg">
                <div className="flex flex-col md:flex-row">
                    {/* Left Thumbnails for larger screens */}
                    <div className="hidden md:flex flex-col space-y-4 mr-6">
                        {selectedProduct.images.map((image, index) => (
                            <img
                                ...
                                // onClick={() => handleThumbnailClick(image.url)} // Change main image when thumbnail is clicked
                    ...
                    {/* Mobile Thumbnail (only visible on screens less than 768px) */}
